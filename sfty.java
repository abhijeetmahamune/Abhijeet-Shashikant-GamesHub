...
f1.setVisible(true);
   ...
   class GuessTheColor implements ActionListener, KeyListener {
    // initializing
    JFrame frame;
    ...
    GuessTheColor() {
        ...
        outOfTime.add(exit);
        // adding actionlistener/keylistener
        ...
        l.setFont(new Font("elephant", Font.BOLD, 30));
        ...
        jb.setFont(new Font("Times New Roman", Font.PLAIN, 30));
        progressBar.setFont(new Font("Times New Roman", Font.PLAIN, 30));
        start.setFont(new Font("", Font.BOLD, 25));
        Red.setFont(new Font("Century Gothic", Font.BOLD, 20));
        Blue.setFont(new Font("Century Gothic", Font.BOLD, 20));
        Black.setFont(new Font("Century Gothic", Font.BOLD, 20));
        Green.setFont(new Font("Century Gothic", Font.BOLD, 20));
        Pink.setFont(new Font("Century Gothic", Font.BOLD, 20));
        Magenta.setFont(new Font("Century Gothic", Font.BOLD, 20));
    ...
    public void keyPressed(KeyEvent e) {
        if (i > 0) {
            ...
            } else if (e.getKeyCode() == KeyEvent.VK_E && e.getKeyCode() == KeyEvent.VK_CONTROL) {
                frame.dispose();
                dialog.dispose();
            } else if (e.getKeyCode() == KeyEvent.VK_W && color == 0) {
                scoreVal++;
                randomColor();
                score.setText("score :" + scoreVal);
                i = 100;
            ...
            } else if (e.getKeyCode() == KeyEvent.VK_E && color == 1) {
                scoreVal++;
                randomColor();
                score.setText("score :" + scoreVal);
                i = 100;
            ...
            } else if (e.getKeyCode() == KeyEvent.VK_S && color == 2) {
                scoreVal++;
                randomColor();
                score.setText("score :" + scoreVal);
                i = 100;
            ...
            } else if (e.getKeyCode() == KeyEvent.VK_D && color == 3) {
                scoreVal++;
                randomColor();
                score.setText("score :" + scoreVal);
                i = 100;
            ...
            } else if (e.getKeyCode() == KeyEvent.VK_X && color == 4) {
                scoreVal++;
                randomColor();
                score.setText("score :" + scoreVal);
                i = 100;
            ...
            } else if (e.getKeyCode() == KeyEvent.VK_C && color == 5) {
                scoreVal++;
                randomColor();
                score.setText("score :" + scoreVal);
                i = 100;
